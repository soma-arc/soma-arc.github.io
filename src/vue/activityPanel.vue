<template>
  <div class="panel-parent">
	...
	<ul class="content">
	  <li>
		<h3><a href="http://auemath.aichi-edu.ac.jp/~ainoue/workshop/TopologyComputer2014.html" target="_blank">Workshop "Topology and Computer 2014"</a> Talk</h3>
		Software displaying the limit set of Kleinian group over the quaternion<br>
		November 16, 2014<br>
		This talk was given by Yuki Miura and Kento Nakamura
	  </li>
	  <li>
    ...
    <h1>Rewards</h1>
    <ul class="content">
	  <li><h3>Mukaidono Prize: The Award for Excellent School Records and Research Activity</h3>
        April 6, 2016
	  </li>
      <li><h3>The Award for a Graduate with Excellent School Records, Meiji University Alumni Association.</h3>
        March 26, 2017
      </li>
	</ul>
  </div>
